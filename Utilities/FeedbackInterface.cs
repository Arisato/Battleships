...
{
    public class FeedbackInterface : IFeedbackInterface
    {
        public void SendFeedback(Event eventAction)
        {
            ...
            switch (eventAction.ActionType)
            {
                ...
                case ActionType.PlayerTurn:
                    ...
                    break;
                case ActionType.Hit:
                    WriteLine($"\n\n{eventAction.TargetName} has been hit!");
                    break;
                case ActionType.ShipHasSunk:
                    WriteLine($"\n\n{eventAction.TargetName} has been sunk!");
                    break;
